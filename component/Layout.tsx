        ...
        <>
            ...
            <div className="container-fluid">
                ...
                <div onMouseEnter={()=>setHoverRdv(true)} onMouseLeave={()=>setHoverRdv(false)}style={{position:"fixed",zIndex:2,marginTop:"150px"}}>
                    {hoverRdv ? <a href={"https://www.celeste-community.com/places/cecile-fabie/"} target={"_blank"}><Image alt="" className={"rdvLogo"} width={70} height={100} src={"/RdvHover.png"} /></a> : <a target={"_blank"} href={"https://www.celeste-community.com/places/cecile-fabie/"}><Image alt={""} className={"rdvLogo"} src={"/Rdv.png"} width={70} height={100}/></a>}
                </div>
